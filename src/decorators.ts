...
export function positiveInteger(target: any, propName: string, descripter: PropertyDescriptor): PropertyDescriptor {
    const originalSet = descripter.set;
    descripter.set = function (value: number) {
